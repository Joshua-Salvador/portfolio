...
function Project({title, type, githubRepo, deployLink, image}) {
  return (
    <div className='project'>
      ...
      {githubRepo.map((repo, i) => (<a key={i} className='project__link' href={repo} target='_blank' rel="noopener noreferrer">{i === 0 && githubRepo[1] !== undefined ? 'Frontend Repo' : i === 0 && githubRepo[1] === undefined ? 'Github' : 'Backend Repo'}</a>))}
